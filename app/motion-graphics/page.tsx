...
const motionGraphicsItems = [
  {
    id: '1',
    title: 'Ajedrez',
    description: 'Short motion piece built around graphic rhythm, cuts, and a concise social format.',
    category: 'social motion',
    fileName: 'ajedrez.mp4',
  },
  {
    id: '2',
  ...
  {
    id: '4',
    title: "Animacion Dia del Padre",
    description: "Campaign animation created for a Father's Day message with a warm and promotional tone.",
